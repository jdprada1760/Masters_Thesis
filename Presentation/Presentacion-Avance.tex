...
\begin{figure}[!ht]
  \centering
  \subfloat[\tiny halo 27 DM shape (small radius)]{\includegraphics[width=0.4\columnwidth]{../Document/pics/MHD_Vs_DM/level4_DM_halo_27_inner.png}}
  \hfill
  \subfloat[\tiny halo 27 DM shape (big radius)]{\includegraphics[width=0.4\columnwidth]{../Document/pics/MHD_Vs_DM/level4_DM_halo_27_outter.png}}
  \hfill
  \subfloat[\tiny halo 27 MHD shape (small radius)]{\includegraphics[width=0.4\columnwidth]{../Document/pics/MHD_Vs_DM/level4_MHD_halo_27_inner.png}}
  \hfill
  \subfloat[\tiny halo 27 MHD shape (big radius)]{\includegraphics[width=0.4\columnwidth]{../Document/pics/MHD_Vs_DM/level4_MHD_halo_27_outter.png}}
...
\begin{figure}[!ht]
  \centering
  \subfloat[\tiny halo 21 DM z=0]{\includegraphics[width=0.4\columnwidth]{./pics/0.png}}
  \hfill
   \subfloat[\tiny halo 21 DM z=0.13]{\includegraphics[width=0.4\columnwidth]{./pics/1.png}}
  \hfill
  \subfloat[\tiny halo 21 DM z=0.27]{\includegraphics[width=0.4\columnwidth]{./pics/2.png}}
  \hfill
  \subfloat[\tiny halo 21 DM z=0.46]{\includegraphics[width=0.4\columnwidth]{./pics/3.png}}
 % \caption{DM density for inner (left) and outer (right) parts of the halo 27. We present both versions: DM (up) \& MHD (down). The horizontal and vertical axes are aligned to the major and medium semi-axes respectively. Here, it is evident that this halo is more spherical at bigger radii and more triaxial at the central parts. }
\normalsize
