...
\begin{itemize}
	...
	\item Study and understand the effect that the presence of visible matter exerts in the shape of the DM haloes in Milky way-like galaxy simulations.
	\item Study and understand the relation of the final shape of the DM halo with respect to its historical shape.
	\item Compare our future results with the state-of-the-art observations that constrain the shape of the Milky way's DM halo.
\end{itemize}
