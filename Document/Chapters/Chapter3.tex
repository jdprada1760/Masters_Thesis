...
\begin{figure}[!ht]
  \centering
  \subfloat[Level4 DM inner Vs outer regions]{\includegraphics[width=0.5\columnwidth]{./pics/Triaxial_Plane/Triaxiality_DM_lvl4.png}\label{fig:DMTriaxial4}}
  \hfill
  \subfloat[Level4 MHD inner Vs outter regions]{\includegraphics[width=0.5\columnwidth]{./pics/Triaxial_Plane/Triaxiality_MHD_lvl4.png}\label{fig:MHDTriaxial4}}
  \hfill
